...
review1 = Review.create(body: "This is my favorite candle of all time. It takes me to my happy place.", candle_id: 1, user_id: 1)
review2 = Review.create(body: "When I light this candle, winter starts. It transports me to a winter wonderland.", candle_id: 2, user_id: 2)
